...
//	fx.targetname = "exploder";
	...
	fx.script_firedelay = (fireFxDelay); // for awhile the script exported strings for this value so we cast it to float
...
loopfxthread ( fxId, fxPos, waittime, fxPos2, fxStart, fxStop, timeout )
{
	...
	if (getcvar("createfx") != "")
	{
		ent = level thread maps\_createfx::createfx_showOrigin ( fxId, fxPos, waittime, fxPos2, "loopfx" );

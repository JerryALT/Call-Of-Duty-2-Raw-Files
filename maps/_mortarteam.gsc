...
//	self.combat_runanim = %mortar_loadguy_run;
	...
	self attach ("xmodel/prop_mortar", "TAG_WEAPON_LEFT");
	...
	mortar setmodel ("xmodel/prop_mortar");
	
	node.mortarSetup = true;
	ent.mortar = mortar;
	node.mortar = mortar;
	self detach ("xmodel/prop_mortar", "TAG_WEAPON_LEFT");
	ent.setup = true;
	ent notify ("loadguy_done");
...
fire(guy)
{
	...
	{
		case 1:
			thread playSoundinSpace("weap_mortar_fire", org);
			break;
		case 2:
			thread playSoundinSpace("weap_mortar_fire_alt", org);
			break;
		default:
			thread playSoundinSpace("weap_mortar_fire", org);
			break;
	...
	else
	{
		...
		switch (randomint(4))
		{
			case 1:
				...
				break;
			case 2:
				playSoundinSpace("mortar_incoming2", target.origin);
				break;
			case 3:
	...
	{
		thread playSoundinSpace("mortar_explosion", target.origin);
...
attachMortar(guy)
{
	...
	if (!guy.mortarAmmo)
		guy attach("xmodel/prop_mortar_ammunition", "TAG_WEAPON_RIGHT");
	guy.mortarAmmo = true;
}
...
detachMortar(guy)
{
	if (guy.mortarAmmo)
	{
		guy detach("xmodel/prop_mortar_ammunition", "TAG_WEAPON_RIGHT");
		thread fire(guy);
	}
	guy.mortarAmmo = false;
}
...
detachMortarOnDeath()
{
	...
	self detach("xmodel/prop_mortar_ammunition", "TAG_WEAPON_RIGHT");
...
//	addNotetrack_attach("loadguy", "attach shell = right", "xmodel/prop_mortar_ammunition", "TAG_WEAPON_RIGHT");
//	addNotetrack_detach("loadguy", "detach shell = right", "xmodel/prop_mortar_ammunition", "TAG_WEAPON_RIGHT");
...
//	addNotetrack_attach("aimguy", "attach shell = right", "xmodel/prop_mortar_ammunition", "TAG_WEAPON_RIGHT");
//	addNotetrack_detach("aimguy", "detach shell = right", "xmodel/prop_mortar_ammunition", "TAG_WEAPON_RIGHT");

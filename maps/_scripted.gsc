main (notifyname, character, node, scr_thread, bitflags)
{
	...
	self thread abrupt_end(notifyname);
		...
		debugprintln ("Preparing to do scripted sequence: " + notifyname);
	...
	*/
	...
	debugprintln ("notify " + notifyname + " character " + self.character);
...
doscriptedanim (notifyname)
{
	...
	debugprintln ("Doing scripted sequence " + notifyname);

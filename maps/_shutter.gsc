...
/*
	...
	switch (ent.model)
	{
		case "xmodel/awning_2x4_1":
		case "xmodel/awning_2x4_2":
		case "xmodel/awning_2x4_3":
		case "xmodel/awning_2x4_4":
		case "xmodel/awning_2x4_5":
			ent.animname = "2x4 awning";
			break;
		case "xmodel/awning_2x5_1":
		case "xmodel/awning_2x5_2":
			ent.animname = "2x5 awning";
			break;
		case "xmodel/awning_2-5x11":
			ent.animname = "5x11 awning";
			break;
		case "xmodel/awning_desert_market_small":
		case "xmodel/awning_desert_market_medium1":
		case "xmodel/awning_desert_market_medium2":
		case "xmodel/awning_desert_market_large":
		case "xmodel/awning_desert_market_large2":
...
palmTrees(ent)
{
	...
	switch (ent.model)
	{
		case "xmodel/tree_desertpalm01":
			ent.animname = "tree_desertpalm01";
			break;
		case "xmodel/tree_desertpalm02":
			ent.animname = "tree_desertpalm02";
			break;
		case "xmodel/tree_desertpalm03":

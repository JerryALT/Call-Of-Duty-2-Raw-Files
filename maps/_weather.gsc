...
thunder()
{
	...
	{
		if (randomint (100) > 50)
			ent playsound ("elm_thunder1", "sounddone");
		else
			ent playsound ("elm_thunder2", "sounddone");
	}
	else
	{
		if (randomint (100) > 50)
			ent playsound ("elm_thunder3", "sounddone");
		else
			ent playsound ("elm_thunder4", "sounddone");
	}

...
main()
{
	...
	level.ambient_track ["exterior"] = "ambient_breakout3_ext";

	level.ambient_track ["exterior2"] = "ambient_breakout2_ext";
	level.ambient_track ["exterior3"] = "ambient_breakout3_ext";
	level.ambient_track ["exterior4"] = "ambient_breakout4_ext";
	level.ambient_track ["exterior5"] = "ambient_breakout5_ext";
	level.ambient_track ["interior"] = "ambient_breakout_int";

...
main()
{
	...
	level.ambient_track ["exterior"] = "ambient_decoytown_ext";
	level.ambient_track ["interior"] = "ambient_decoytown_ext";
	...
	ambientEvent("interior", "elm_windgust1",	1.0);
	ambientEvent("interior", "elm_windgust2",	1.0);
	ambientEvent("interior", "elm_windgust3",	1.0);
	ambientEvent("interior", "elm_battle_incoming10",		0.2);	
	ambientEvent("interior", "elm_battle_incoming11",		0.2);	
	ambientEvent("interior", "elm_c47_flyover1",		0.1);	
	ambientEvent("interior", "elm_c47_flyover2",		0.1);	
	ambientEvent("interior", "elm_c47_flyover3",		0.1);	
	ambientEvent("interior", "elm_c47_flyover4",		0.1);	
